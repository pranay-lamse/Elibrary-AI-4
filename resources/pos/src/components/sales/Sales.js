...
const Sales = (props) => {
    ...
    const goToEdit = (item) => {
        const id = item.id;
        window.location.href = "#/admin/pos/sales/edit/" + id;
    };
    ...
    const goToDetailScreen = (ProductId) => {
        window.location.href = "#/admin/pos/sales/detail/" + ProductId;
    };
    ...
    const onCreateSaleReturnClick = (item) => {
        ...
        window.location.href =
            item.is_return === 1
                ? "#/admin/pos/sales/return/edit/" + id
                : "#/admin/pos/sales/return/" + id;
    };
