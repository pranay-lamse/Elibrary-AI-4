...
const PDFpreivew = (props) => {
    ...
    console.log({ filePath, libraryId });
    return (
        // <Document
        //     file={{
        //         url: filePath
        ...
        <Worker workerUrl="https://unpkg.com/pdfjs-dist@2.7.570/build/pdf.worker.js">
            <Demo
                file={
                    libraryId == "111"
                        ? "https://dindayalupadhyay.smartcitylibrary.com/uploads/QuotationLetters/" +
                          filePath
                        : libraryId == "222"
                        ? "https://kundanlalgupta.smartcitylibrary.com/uploads/QuotationLetters/" +
                          filePath
                        : "https://rashtramatakasturba.smartcitylibrary.com/uploads/QuotationLetters/" +
                          filePath
                }
            />
        </Worker>
