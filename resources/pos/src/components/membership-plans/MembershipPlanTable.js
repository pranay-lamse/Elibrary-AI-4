...
export const MembershipPlanTable = (props) => {
    const { membershipPlans, onClickModal, sortAction, sortObject, currency } =
        props;
    ...
    const headers = [
        ...
        },
        {
            ...
            name: getFormattedMessage(
                "membership-plans.select.frequency.label"
            ),
        },
        {
            id: "price",
            name: getFormattedMessage("membership-plans.input.price.label"),
        },
    ];
    ...
    const renderMemberShipPlanFrequency = (membershipPlan) => {
        switch (membershipPlan.frequency) {
            ...
            case membershipPlanFrequency.YEARLY:
                membershipPlan.frequency_name = "Yearly";
                return membershipFrequencyOptions[1].name;
            default:
                membershipPlan.frequency_name = "Lifetime";
                return membershipFrequencyOptions[2].name;
        }
    };
    return (
