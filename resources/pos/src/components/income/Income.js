...
import { fetchExpenses } from "../../store/action/incomesAction";
import DeleteExpense from "./DeleteIncome";
...
const Income = (props) => {
    ...
    const goToEditProduct = (item) => {
        const id = item.id;
        navigate(`/admin/pos/incomes/edit/${id}`);
    };
    ...
    const columns = [
        ...
        {
            name: getFormattedMessage("income.input.title.label"),
    ...
    return (
        <MasterLayout>
            <TopProgressBar />
            <TabTitle title={placeholderText("incomes.title")} />
            <ReactDataTable
                columns={columns}
                items={itemsValue}
                onChange={onChange}
                isLoading={isLoading}
                ButtonValue={getFormattedMessage("income.create.title")}
                totalRows={totalRecord}
                to="#/admin/pos/income/create"
            />
            <DeleteIncome
                onClickDeleteModel={onClickDeleteModel}
