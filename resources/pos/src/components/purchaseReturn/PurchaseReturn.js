...
const PurchaseReturn = (props) => {
    ...
    const goToEditProduct = (item) => {
        const id = item.id;
        window.location.href = "#/admin/pos/purchase-return/edit/" + id;
    };

    const goToPurchaseReturn = (ProductId) => {
        window.location.href =
            "#/admin/pos/purchase-return/detail/" + ProductId;
    };
    ...
    const columns = [
        ...
        },
        {
            ...
            selector: (row) =>
                currencySymbolHendling(allConfigData, row.currency, row.paid),
            sortField: "paid",
            sortable: false,
        },
        {
            ...
            selector: (row) =>
                currencySymbolHendling(allConfigData, row.currency, row.due),
            sortField: "due",
            sortable: false,
        },
        {
    ...
    return (
        <MasterLayout>
            ...
            <ReactDataTable
                ...
                to="#/admin/pos/purchase-return/create"
