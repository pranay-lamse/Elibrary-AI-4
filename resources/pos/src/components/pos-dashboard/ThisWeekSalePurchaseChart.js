...
const ThisWeekSalePurchaseChart = (props) => {
    ...
    const valueFormatter = (tooltipItems) => {
        ...
        return (
            label +
            " : " +
            currencySymbolHendling(allConfigData, currencySymbol, value, true)
        );
    };
    ...
    const data = {
        ...
        datasets: [
            {
                label: placeholderText("expenses.title"),
