...
export const BookItemTable2 = (props) => {
            ...
            >
                ...
                <tbody>
                    {bookItems.map((bookItem) => {
                        const ebooksubscriptions =
                            bookItem?.ebooksubscriptions?.map(
                                (ebooksubscriptions) => {
                                    return (
                                        <li>
                                            <a
                                                href={`#/admin/pos/members/${ebooksubscriptions?.member?.id}/details`}
                                            >
                                                {ebooksubscriptions?.member
                                                    ?.full_name + ""}
                                            </a>
                                            <br></br>
                                        </li>
