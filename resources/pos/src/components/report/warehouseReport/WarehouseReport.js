...
const WarehouseReport = (props) => {
    ...
    const newFirstElement = { attributes: { name: "All Libraries" }, id: null };
    const newArray = [newFirstElement].concat(array);

    return (
        <MasterLayout>
            <TopProgressBar />
            <TabTitle title={placeholderText("library.title")} />
            <Row className="g-4">
                <Col md={4} className="mb-5 col-12">
                    {newArray && (
                        <ReactSelect
                            data={newArray}
                            ...
                            placeholder={placeholderText(
                                "purchase.select.library.placeholder.label"
                            )}
                        />
                    )}
                </Col>
