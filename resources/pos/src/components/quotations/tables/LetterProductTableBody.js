...
import ProductModal from "./LetterProductModal";
...
const LetterProductTableBody = (props) => {
    const {
        singleProduct,
        index,
        updateProducts,
    ...
    return (
        <tr key={index} className="align-middle">
            <td>
                <h4 className="product-name">{singleProduct.id}</h4>
            ...
            <td>
                ...
                {currencySymbolHendling(
                    allConfigData,
                    frontSetting.value && frontSetting.value.currency_symbol,
                    parseInt(singleProduct.quantity) * singleProduct.price
                )}
            </td>
            {singleProduct.isSaleReturn || singleProduct.isSaleReturnEdit ? (
                ""
