                        ...
                        <div>
                            <Field
                                ...
                                label={getFormattedMessage(
                                    "profile.toggle.is-active.label"
                                )}
                    ...
                    {initialValues.isCreate ? (
                        <Col xs={12} sm={6} lg={6}>
                            <Field
                                ...
                                required
                                autoComplete={
                                    initialValues ? "off" : "new-password"
                                }
                    ...
                    {initialValues.isCreate ? (
                        <Col xs={12} sm={6} lg={6}>
                            <Field
                                ...
                                component={InputGroup}
                                appendGroupText={
                                    isConfirmPassword ? "eye-slash" : "eye"
                                }
                                isAppendIcon
...
const memberForm = reduxForm({ form: "memberForm", validate: memberValidate })(
    MemberForm
);
