...
const MemberAttendanceDetails = props => {
            ...
            <Row>
                <Col sm={12} className="mb-2 d-block d-sm-flex justify-content-between">
                    ...
                    <div className="d-block d-sm-flex">
                        <Button className="mr-2" color="primary text-white" onClick={() => onClickEditMember(+match.params.id)}>
...
MemberAttendanceDetails.propTypes = {
...
export default connect(mapStateToProps, { fetchMember, toggleModal })(MemberAttendanceDetails);
