...
const BookFormCard = (props) => {
    ...
    const [onChangeProduct] = bookCreationWarning(change);
            ...
            <Col xs={8} className="book-form-card__primary-details">
                ...
                <Row>
                    {isImportBook ? (
                        <Col xs={12} sm={6}>
                            <Field
                                ...
                                required
                                inputRef={inputRef}
                                onBlur={(e) => onFocusChangeISBN(e)}
                                groupText="id-card"
                                onClick={() => onFocusChangeISBN}
                    ...
                    <Col xs={12} sm={6}>
                        <Field
                            name="authors"
                            label="books.input.author.label"
                            required
                            isMulti={true}
                            onChange={(options) =>
                                onChangeAuthor(options, authors, "new_authors")
                            }
                            options={authors}
                    ...
                    <Col xs={12} sm={6}>
                        <Field
                            name="genres"
                            label="books.input.genres.label"
                            required
                            isMulti={true}
                            onChange={(options) =>
                                onChangeGenres(options, genres, "new_genres")
                            }
                            options={genres}
                    ...
                    <Col xs={12} sm={6}>
                        <Field
                            name="tags"
                            label="books.input.tags.label"
                            isMulti={true}
                            onChange={(options) =>
                                onChangeTags(options, tags, "new_tags")
                            }
                            options={tags}
