 ...
 */
class BookItemRepository2 extends BaseRepository2 implements BookItemRepositoryInterface2
{
    /**
     * @var array
     */
    ...
    {
        $available = collect($records->where('status', BookItem2::STATUS_AVAILABLE));
        $notAvailable = collect($records->where('status', BookItem2::STATUS_NOT_AVAILABLE))
