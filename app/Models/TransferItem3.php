 ...
 * @mixin \Eloquent
 */
class TransferItem3 extends BaseModel implements JsonResourceful
{
    ...
    {
        return $this->belongsTo(Product3::class, 'product_id', 'id');
    }
    public function bookItem(): BelongsTo
    {
        return $this->belongsTo(BookItem3::class, 'product_id', 'id');
    }
