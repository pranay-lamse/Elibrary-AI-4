...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::group(['middleware' => ['permission:manage_transfers']], function () {
        ...
        Route::get('transfers2', [TransferAPIController::class, 'transfers2']);
    });
    ...
    Route::group(['middleware' => ['permission:manage_expenses']], function () {
        ...
        Route::resource('incomes', IncomeAPIController::class);
...
Route::post('/resources/update/{id}', [ResourceController::class, 'update2']);
